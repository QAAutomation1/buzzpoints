 ...
 * @Comments :This automation class will login into admin portal and Change Future Request.
 */
package com.fisoc.admin;

import org.apache.poi.openxml4j.exceptions.InvalidFormatException;
import org.testng.annotations.Test;
import com.fisoc.admin.helpers.FutureChangeRequestTestHelper;
import com.fisoc.util.BaseClass;

public class FutureChangeRequestTest extends BaseClass
{
	/**
	...
	@Test(groups = { "Regression" ,"Functional","Smoke", "AdminSiteRegression"})
	 ...
	 {
		FutureChangeRequestTestHelper futureRequest = new FutureChangeRequestTestHelper();
